...
class VendedoresModel extends Model {
    ...
    public function update($item){
        $query = $this->db->connect()->prepare("UPDATE VENDEDORES SET nombre = :nombre, apellido_paterno = :apellido_paterno, apellido_materno = :apellido_materno, direccion = :direccion, telefono = :telefono, email = :email, curp = :curp WHERE id = :id");
    ...
    public function cambiarContrasenia($id, $contrasenia) {
        $query = $this->db->connect()->prepare("UPDATE VENDEDORES SET contrasenia = :contrasenia, contrasenia_default = '0' WHERE id = :id");
